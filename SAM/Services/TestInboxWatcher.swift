...
final class TestInboxWatcher {
    ...
    func start() {
        ...
        // RSVP test harness is available via RSVPTestHarness.runAll()
        // but no longer auto-runs on every launch — it burns CPU/AI
        // during startup and competes with the foreground UI.
