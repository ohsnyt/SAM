...
public struct ContextChip: Identifiable, Codable, Hashable, Sendable {
...
public struct InteractionChip: Identifiable, Codable, Hashable, Sendable {
    public let id:       UUID
...
struct PersonInsight: Identifiable, Codable, Hashable, Sendable {
    let id: UUID
...
public struct ContextProductModel: Identifiable, Codable, Hashable, Sendable {
    public let id:            UUID
    public let title:         String
    public let subtitle:      String?
...
public struct InteractionModel: Identifiable, Codable, Hashable, Sendable {
    public let id:       UUID
    public let title:    String
    public let subtitle: String
...
struct ContextInsight: Identifiable, Codable, Hashable, Sendable {
    let id: UUID
...
public enum JointInterestType: String, Codable, CaseIterable, Sendable {
    case spousal
...
public enum CoverageRole: String, Codable, CaseIterable, Sendable {
    case insured
    case beneficiary
    case jointBeneficiary
}
...
/// states.
public enum EvidenceTriageState: String, Codable, CaseIterable, Sendable {
    case needsReview
    case done
}
...
public struct EvidenceSignal: Identifiable, Codable, Hashable, Sendable {
    public let id:         UUID
...
public struct ParticipantHint: Identifiable, Codable, Hashable, Sendable {
...
///
/// Note: All properties are immutable for proper Sendable conformance.
/// Updates create modified copies rather than mutating in place.
public struct ProposedLink: Identifiable, Codable, Hashable, Sendable {
    public let id: UUID
    ...
    // ── Lifecycle ─────────────────────────────────────────────────
    public let status:     LinkSuggestionStatus
    ...
    public func withStatus(_ newStatus: LinkSuggestionStatus, decidedAt: Date? = Date()) -> ProposedLink {
        ProposedLink(
            id: id,
            target: target,
            targetID: targetID,
...
public enum EvidenceLinkTarget: String, Codable, Hashable, Sendable {
    case person
    case context
}

/// The lifecycle state of a single link suggestion.
public enum LinkSuggestionStatus: String, Codable, CaseIterable, Hashable, Sendable {
    case pending
    case accepted
    case declined
...
/// is implemented.
enum IntegrityStatus: String, Codable, CaseIterable, Sendable {
    case valid
    case needsReview
    case orphaned
}
