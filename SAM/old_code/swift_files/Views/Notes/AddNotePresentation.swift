...
public struct AddNotePresenter: ViewModifier {
    ...
    @State private var isProcessing = false  // Phase 1.1: Track processing state
        ...
        .sheet(isPresented: $showing) {
            AddNoteForPeopleView(
                ...
                do {
                    ...
                    // Phase 1.1: Start AI analysis asynchronously and track completion
                    Task {
                        ...
                        // Phase 1.1: Update processing state when done
                        await MainActor.run {
                            isProcessing = false
                        }
                    }
                    ...
                    // Phase 1.1: Stop processing on error
                    isProcessing = false
