...
public enum MailMetadataParser {
    ...
    public static func parse(headers: [String: String]) -> MailMessageMetadata? {
        ...
        return MailMessageMetadata(messageID: messageID, threadID: threadID, date: date, from: from, to: to, cc: cc, bcc: bcc, subject: subject)
    }
